        ...
        <>
            <div className="header d-flex align-items-center justify-content-space-between">
                <div className="header-left-items d-flex align-items-center mxy-30">
                    ...
                    <div className="logo">
                        <a href="#">
                            <svg class="external-icon pointer" 
                            viewBox="0 0 90 20" 
                            focusable="false" 
                ...
                <div className="header-middle-items d-flex align-items-center">
                    <div className="input-box relative">
                        ...
                        <div className="search-box absolute d-flex align-items-center justify-content-center search-scope">
                            <svg
                            viewBox="0 0 24 24"
                            preserveAspectRatio="xMidYMid meet"
                            focusable="false"
                    ...
                    <div className="voice-search d-flex align-items-center bg-hover">
                        <svg
                            viewBox="0 0 24 24"
                            preserveAspectRatio="xMidYMid meet"
                            focusable="false"
